...
class PINN(torch.nn.Module):
    def __init__(self, in_dimensions=3, hidden_size=64, nr_hidden_layer=5, out_dimensions=5, tanh_activation=False):
        super().__init__()
        ...
        self.activation = torch.nn.Tanh() if tanh_activation else torch.nn.SiLU()
